 ...
 *  @generated
 */
package com.example.grpc.thrift.template;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.16.0)", date = "2022-03-22")
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  public Message setSendTime(@org.apache.thrift.annotation.Nullable java.lang.String sendTime) {
    this.sendTime = sendTime;
    return this;
  }
  ...
  public int compareTo(Message other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSendTime(), other.isSetSendTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSendTime()) {
